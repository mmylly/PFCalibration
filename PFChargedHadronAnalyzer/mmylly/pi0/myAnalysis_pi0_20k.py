...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step3_pi0_20k.root'),
...
process.pfChargedHadronAnalyzer = cms.EDAnalyzer(
    ...
    rootOutputFile = cms.string("step99_pi0_20k_trees.root"),# the root tree
