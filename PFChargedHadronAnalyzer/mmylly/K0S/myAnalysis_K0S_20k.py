...
# with command line options: step3_K0L_20k --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --runUnscheduled --conditions auto:run1_mc -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidationNoHLT+@miniAODValidation,DQM:@standardDQMFakeHLT+@miniAODDQM --eventcontent RECOSIM,MINIAODSIM,DQM -n 20000 --filein file:step2.root --fileout file:step3.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step3_K0S_20k.root'),
...
process.pfChargedHadronAnalyzer = cms.EDAnalyzer(
    ...
    rootOutputFile = cms.string("step99_K0S_20k_trees.root"),# the root tree
