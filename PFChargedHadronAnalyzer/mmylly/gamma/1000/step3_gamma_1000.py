...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_gamma_1000.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3_gamma_1000 nevts:1000'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_gamma_1000.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_gamma_1000_inMINIAODSIM.root'),
