...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step3_gamma_1000.root'),
...
process.pfChargedHadronAnalyzer = cms.EDAnalyzer(
    ...
    rootOutputFile = cms.string("step99_gamma_1000_trees.root"),# the root tree
