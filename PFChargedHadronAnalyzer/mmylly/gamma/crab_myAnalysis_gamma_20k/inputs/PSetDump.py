...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step3_gamma_20k.root'),
...
process.pfChargedHadronAnalyzer = cms.EDAnalyzer("PFChargedHadronAnalyzer",
    ...
    ecalMax = cms.double(1000000000.0),
    genParticles = cms.InputTag("genParticles"),
    hcalMin = cms.double(0.5),
    nEtaMin = cms.vdouble(1.4, 1.6, 2.0, 2.4, 2.6),
    nHitMin = cms.vint32(14, 17, 20, 17, 10),
    nPixMin = cms.int32(2),
    pMin = cms.double(1.0),
    ptMin = cms.double(1.0),
    rootOutputFile = cms.string('step99_gamma_20k_trees.root'),
